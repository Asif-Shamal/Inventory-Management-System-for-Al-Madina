...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">{{ __('Change Password Page') }} </h4><br><br>
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">{{ __('Old Password') }}</label>
                <div class="col-sm-10">
...
<input type="submit" class="btn btn-info waves-effect waves-light" value="{{ __('Change Password') }}">
            </form>
