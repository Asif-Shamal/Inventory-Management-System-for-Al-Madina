...
<html lang="en">
    ...
    {{-- language --}}
    <header style="background-color: rgb(56, 56, 56,0.099)" id="page-topbar">
        <div class="navbar-header navbar-brand-box ">
            <div  style="background-color: #fff; margin-left:-543px" class="d-flex">
 ...
 <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group mb-3 row">
            <div class="col-12">
                <input class="form-control" id="username" name="username" type="text"  placeholder="{{ __('Username') }}">
            </div>
            @error('username')
