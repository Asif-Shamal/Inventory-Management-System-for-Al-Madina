    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                >
                    <h4 class="mb-sm-0">{{ __('Supplier Wise Stock Report') }}</h4>
                                    ...
                                    <div class="">
                                        ...
                                        <div class="d-print-none">
                                            <div class="float-end">
                                                ...
                                                ></a>
                                                <a href="{{ route('supplier.stock.report.download') }}" class="btn btn-primary waves-effect waves-light ms-2">{{ __('Download') }}</a>
