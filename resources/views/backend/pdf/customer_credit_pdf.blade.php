                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">{{ __('Customer Credit Report') }}</h4>

                                    {{-- <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">{{ __('Customer Credit Report') }}</li>
                                        </ol>
                                    </div> --}}
        ...
        <i>{{ __('Printing Time') }} : {{ $date->format('F j, Y, g:i a') }}</i>   
                    ...
                    <div class="d-print-none">
                        <div class="float-end">
                            ...
                            <a href="{{ route('customer-credit-report.download') }}" class="btn btn-primary waves-effect waves-light ms-2">{{ __('Download') }}</a>
                    </div>
                </div>
            </div>
