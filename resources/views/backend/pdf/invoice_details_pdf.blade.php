 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0"> {{ __('Customer Payment Report') }} </h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>{{ __('Invoice No') }} # {{ $payment['invoice']['invoice_no'] }}</strong></h4>
                <h3>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>{{ __('Customer Invoice') }}</strong></h3>
                </div>
                <div class="">
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>{{ __('Customer Mobile') }}</strong></td>
            <td class="text-center"><strong>{{ __('Address') }}</strong>
            </td>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>{{ __('Current Stock') }}</strong>
            </td>
        ...
        @endforeach
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="no-line"></td>
                <td class="no-line text-center">
                    <strong>{{ __('Paid Amount') }}</strong></td>
             ...
             <tr>
                ...
                <td class="no-line"></td>
                <td class="no-line text-center">
                    <strong>{{ __('Due Amount') }}</strong></td>
            ...
            <tr>
                <td colspan="7" style="text-align: center;font-weight: bold;">{{ __('Paid Summary') }}</td>
                
            </tr>

             <tr>
                <td colspan="4" style="text-align: center;font-weight: bold;">{{ __('Date') }} </td>
                <td colspan="3" style="text-align: center;font-weight: bold;">{{ __('Amount') }}</td>
