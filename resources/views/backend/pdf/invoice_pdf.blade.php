    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                <h4 class="float-end font-size-16"><strong>{{ __('Invoice No') }} # {{ $invoice->invoice_no }}</strong></h4>
                <h3>
      ...
      @php
        ...
        <tr>
           <td class="text-center">{{ $key+1 }}</td>
            ...
            {{-- <td class="text-center">{{ $details['user']['name']}}</td> --}}
                ...
                <td class="no-line text-end"><h4 class="m-0">${{ $payment->total_amount }}</h4></td>
                    ...
                    <div class="d-print-none">
                        <div class="float-end">
                            ...
                            <a href="{{ route('invoice.download', $invoice->id) }}" class="btn btn-primary waves-effect waves-light ms-2">{{ __('Download') }}</a>
                        </div>
                    </div>
                </div>
            </div>
