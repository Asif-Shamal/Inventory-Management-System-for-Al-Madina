 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">{{ __('Daily Invoice Report') }}</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">{{ __('Daily Invoice Report') }}</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>{{ __('Daily Invoice Report') }} 
                ...
                <td class="no-line text-end"><h4 class="m-0">${{ $total_sum}}</h4></td>
                    ...
                    <div class="d-print-none">
                        <div class="float-end">
                            ...
                            <a href="{{ route('daily-invoice-report.download', ['start_date' => $start_date, 'end_date' => $end_date]) }}" class="btn btn-primary waves-effect waves-light ms-2">{{ __('Download') }}</a>
                        </div>
                </div>
                </div>
            </div>
