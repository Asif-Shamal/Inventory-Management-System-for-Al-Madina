        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">{{ __('Customer Wise Paid Report') }}</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                            <li class="breadcrumb-item active">{{ __('Customer Wise Paid Report') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-12">
                                <div>
                                    ...
                                    <div class="">
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><strong>{{ __('Invoice No') }}  </strong>
                                                        </td>
                                                        <td class="text-center"><strong>{{ __('Date') }}</strong>
                                                        </td>
                                                        <td class="text-center"><strong>{{ __('Due Amount') }}  </strong>
                                                        </td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="no-line text-center">
                                                            <strong>{{ __('Grand Due Amount') }}</strong></td>
                                        ...
                                        @endphp         
                                        <i>{{ __('Printing Time') }} : {{ $date->format('F j, Y, g:i a') }}</i>   

                                        <div class="d-print-none">
                                            <div class="float-end">
                                                <a href="javascript:window.print()" class="btn btn-success waves-effect waves-light"><i class="fa fa-print"></i></a>
                                                <a href="{{ route('customer-wise-paid-report.download') }}" class="btn btn-primary waves-effect waves-light ms-2">{{ __('Download') }}</a>
