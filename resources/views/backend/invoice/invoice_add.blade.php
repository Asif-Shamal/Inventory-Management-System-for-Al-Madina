                            ...
                            <div class="row new_customer" style="display: none">
                                <div class="form-group col-md-4">
                                    <input
                                        ...
                                        id="name"
                                        class="form-control"
                                        placeholder="{{ __('Write Customer Name') }}"
                                    />
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <input
                                        ...
                                        id="mobile_no"
                                        class="form-control"
                                        placeholder="{{ __('Write Customer Mobile No') }}"
                                    />
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    <input
                                        ...
                                        id="email"
                                        class="form-control"
                                        placeholder="{{ __('Write Customer Email') }}"
                                    />
                                </div>
                            </div>
