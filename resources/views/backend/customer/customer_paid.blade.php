    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                >
                    <h4 class="mb-sm-0">{{ __('Paid Customer All') }}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a
                            href="{{ route('paid.customer.print.pdf') }}"
                            class="btn btn-dark btn-rounded waves-effect waves-light"
                            target="_black"
                            style="float: right"
                            ><i class="fa fa-print"> {{ __('Print Paid Customer') }} </i></a
                        >
                        <br />
                        <br />

                        <h4 class="card-title">{{ __('Paid All Data') }}</h4>
